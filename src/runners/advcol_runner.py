...
class AdversarialCollectorRunner:
    ...
    def run(self):
        ...
        self.adv_gen = NoiseAttack(mac = self.mac, infected_idx= self.infected_idx, epsilon=self.epsilon,params = self.noise_params)
        ...
        while not terminated:
            ...
            observations.append(self.mac._build_inputs(self.batch, t=self.t).numpy())
        ...
        return stats, np.array(observations)
