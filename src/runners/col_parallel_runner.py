...
class ParallelCollector:
    ...
    def reset(self):
        ...
        self.observations.append(self.mac._build_inputs(self.batch, t=self.t).numpy())
    ...
    def run(self, test_mode=True):
        ...
        stats = {"return": episode_returns, "ep_length":cur_stats["ep_length"] }
        if 'sc2' in self.args.env:
            stats["battle_won"] = cur_stats["battle_won"]
    

        return stats, self.observations
